...
@section('content')
    ...
    <div class="w-full px-96 mx-auto  ">
        <form class="bg-gray-800" method="POST" action="{{route('quiz.store') }}">
            @csrf
            <div id="title " class="mt-5">
                <label for="country" class="block bg-blue-600 p-2 rounded-t-lg font-medium text-gray-800">Quiz Oluştur</label>
            </div>
            <div class="col-span-6 bg-blue-500  sm:col-span-3 p-2 rounded-b-lg pb-14">
                ...
                <div class="col-span-6 m-2 sm:col-span-4">
                    ...
                    <input type="text" name="quiz_title" id="quiz_title"  class="mt-1 block w-full py-2 px-3 border border-gray-800 text-white bg-gray-800 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                </div>

                <div class="col-span-6 m-2 sm:col-span-4">
                    <label for="quiz_description" class="block text-sm font-medium text-gray-800">Quiz Açıklaması :</label>
                    <textarea type="text" name="quiz_description" id="quiz_description"  class="mt-1 block w-full pt-2 pb-10 px-3 border border-gray-800 text-white bg-gray-800 bg-white rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"></textarea>
                </div>
                ...
                <div class="float-right">
                    <button class="bg-blue-700 hover text-white m-2 p-2 rounded-lg" type="submit">Add Quiz</button>
                </div>
