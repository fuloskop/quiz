...
<div class="w-full max-w-xs m-auto bg-indigo-100 rounded p-5" style="background-color : #262d3f">
    ...
    <form  method="post" action="{{url('/login/checklogin')}}">
        ...
        <div>
            ...
            <input class="w-full p-2 mb-6 bg-gray-800  focus:text-indigo-700 text-white border-b-2 border-indigo-500 outline-none focus:bg-gray-300" type="email" name="email" >
        </div>
        <div>
            <label class="block mb-2 text-indigo-500" for="password">Password</label>
            <input class="w-full p-2 mb-6 bg-gray-800 focus:text-indigo-700 text-white border-b-2 border-indigo-500 outline-none focus:bg-gray-300" type="password" name="password">
        </div>
        <div>
